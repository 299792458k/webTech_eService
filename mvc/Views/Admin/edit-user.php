...
.nav-borders .nav-link {
    ...
    <div class="ct">Cập nhật thông tin người dùng</div>
        ...
        <div style="text-align:left; margin-top: 10px;margin-right: 10px;">
            <label >Email :</label>
            <input type="email" class="" value=""  name="email" >     
            <?php echo "email"; ?>
        </div>

        <div style="text-align:left; margin-top: 10px;margin-right: 10px;">
            <label >Ngày sinh :</label>
            <input type="date" class="" value="" name="dob" >  
        ...
        <div class="">
            <input class="" type="radio" name="gender"   value="Male"  selected>
        ...
        <div class="">
            <input class="" type="radio" name="gender"   value="Other">
            <label class="" >Khác</label>
        </div>

        <ul style="text-align: right;">
            <li>
            <input type="submit" value="Save Changes" class="loginbutton" name="save_changes" >        
</li>
                <li style="right: 20%;">
                    <a href="manage-user.php" class="" style="text-decoration:none;">Đóng</a>
</li>
</ul>
            </form> -->
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form>
                        ...
                        <button class="btn btn-primary" type="button"><a href="manage-user.php" >Đóng</a></button>
                    </form>
                </div>
            </div>
        </div>
