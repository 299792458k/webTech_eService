 ...
 .container .content .right-side{
  ...
  <div class="container">
    <div class="content">
      ...
      <form action="#">
        <div class="input-box">
          <input type="text" placeholder="Nguyễn Văn Anh">
        </div>

        <div class="input-box">
          <input type="text" placeholder="anhsao12">
        </div>
        <div class="input-box">
          <input type="text" placeholder="0912878588">
        </div>
        <div class="input-box">
          <input type="text" placeholder="anhanh12">
        </div>
        <div class="button">
          <input type="button" value="Xóa người dùng" >
        </div>
      </form>
    </div>
    </div>
