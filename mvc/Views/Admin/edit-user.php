                ...
                <div class="container">
                    <div class="content">
                        ...
                        <div class="right-side">
                            ...
                            <form id="edit-user" action="/webTech_eService/admin/edit" method="POST">
                                <?php
                                $admin = mysqli_fetch_array($data['admin']);
                                ?>
                                <input type="hidden" name="id" value="<?php echo $admin['id'] ?>">
                                <div class="input-box">
                                    <label class="small mb-1" for="inputEmailAddress">Email:</label>
                                    <input id="inputEmailAddress" type="email" placeholder="Nhập email" value="<?php echo $admin['email'] ?>" name="email" required readonly>
                                </div>

                                <div class="input-box">
                                    <label class="small mb-1" for="inputPasword">Mật khẩu:</label>
                                    <input class="form-control" id="inputPasword" type="password" placeholder="Nhập mật khẩu" value="<?php echo $admin['password'] ?>" name="password" required>
                                </div>
                                ...
                                <div class="input-box">
                                    ...
                                    <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your full name" value="<?php echo $admin['name'] ?>" name="name" required>
